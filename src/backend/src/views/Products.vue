    ...
    <div class="bg-white p-5 rounded-lg shadow">
        <div class="flex justify-between border-b-2 pb-3">
            ...
            <table class="table-auto w-full">
                <thead>
                    <tr>
                        <TableHeaderCell @click="sortProduct" field="id" :sort-field="sortField" :sort-direction="sortDirection">ID</TableHeaderCell>
                        <TableHeaderCell :sort-field="sortField" :sort-direction="sortDirection">画像</TableHeaderCell>
                        <TableHeaderCell @click="sortProduct" field="title" :sort-field="sortField" :sort-direction="sortDirection">タイトル</TableHeaderCell>
                        <TableHeaderCell @click="sortProduct" field="price" :sort-field="sortField" :sort-direction="sortDirection">値段</TableHeaderCell>
                        <TableHeaderCell @click="sortProduct" field="updated_at" :sort-field="sortField" :sort-direction="sortDirection">最終更新日</TableHeaderCell>
                    </tr>
                </thead>
            ...
            <div v-if="!products.loading" class="flex justify-between items-center mt-5">
                ...
                <nav v-if="products.total > products.limit"
                    ...
                    <a v-for="(link, i) of products.links" :key="i" :disabled="!link.url" href="#"
                        @click.prevent="getForPage(link)" aria-current="page"
