            ...
            <DialogPanel
              ...
              <header class="py-3 px-4 flex justify-between items-center">
                <DialogTitle as="h3" class="text-lg font-medium leading-6 text-gray-900">
                  {{ user.id ? `ユーザーを更新: "${props.user.name}"` : 'ユーザーを新規作成' }}
                </DialogTitle>
              ...
              <form @submit.prevent="onSubmit">
                <div class="bg-white px-4 pt-5 pb-4">
                  <CustomInput class="mb-4" v-model="user.name" label="氏名" :errorMsg="errorMsg.name" />
                  <CustomInput class="mb-4" v-model="user.email" label="メールアドレス" :errorMsg="errorMsg.email"  />
                  <CustomInput type="password" class="mb-4" v-model="user.password" label="パスワード" :errorMsg="errorMsg.password"  />
                  <CustomInput type="password" class="mb-4" v-model="user.password_confirmation" label="パスワード確認" />
                </div>
