<script setup>
import { HomeIcon, UserIcon, ViewListIcon, ChartBarIcon, UserGroupIcon } from '@heroicons/vue/outline'
</script>
...
<template>
  <div class="w-[200px] transition-all bg-indigo-700 text-white py-4 px-2">
    ...
    <router-link :to="{ name: 'reports' }" class="flex items-center p-2 rounded transition-colors hover:bg-black/30">
      <span class="mr-2 text-gray-300">
        <ChartBarIcon class="w-5" />
      </span>
      <span class="text-xs">
