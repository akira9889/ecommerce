        ...
        <div class="container lg:w-2/3 xl:w-2/3 mx-auto">
            ...
            <div class="bg-white p-3 rounded-md shadow-md">
                ...
                @if ($order->isOrderCancelable())
                    <form action="{{ route('order.cancel', $order) }}" class="mt-4" id="cancel-form" method="post">
                        @csrf
                        <button type="button" onclick="orderCancel(this)"
                            class="bg-red-500 text-white flex justify-center items-center w-full py-3 text-lg">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-1" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z" />
